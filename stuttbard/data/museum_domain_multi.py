def main(parametrize):
    ...
    histories.append([
        ("List me some %(topic)s museums in Stuttgart.", 
            "Sure, here is a list of museums about %(topic)s: slot_df_name.", 
            "domain = museum ; about = %(topic)s"),
        ("More specific I am interested in museums with the topic %(specific_topic)s.", 
            "The list of museums about %(specific_topic) includes: slot_df_name.", 
            "about_specific = %(specific_topic)"),
        ("Can you give me the phone number of the %(index_text)s one", 
    ...
    histories.append([
        ("What topics do the museums in Stuttgart have?", 
            ...
            "domain = museum"),
        ("I want to visit a museum in the area %(area)s", 
            "In the area %(area)s we have museums about the topics slot_df_about", 
            "area = %(area)s"),
    ...
    histories.append([
        ("I am interested in the %(name)s museum in Stuttgart.", 
            "For the slot_entity_name museum I can give you information on these properties: df_columns",
            "domain = museum ; name = %(name)s"),
        ("What is the adress of the %(name)s museum in Stuttgart?", 
            "The slot_entity_name museum has the adress slot_entity_address",
            ""),
        ("In which street is the %(name)s museum?", 
            "You can find the slot_entity_name museum in the slot_entity_street street.",
            ""),
        ("Tell me the house number of the %(name)s museum!", 
            "The house number is slot_entity_house_number.",
            ""),
        ("Show me more information about the %(name)s museum in Stuttgart!", 
    ...
    histories.append([
        ...
        ("What is the rating of the %(index_text)s one?", 
            "The %(index_text)s museum called slot_entity_name has a google rating of slot_entity_rating.",
            "entity_index = %(index_int)s"),
        ("Is the museum for children?", 
            "The suitability of the slot_entity_name museum for children is: slot_entity_children.",
            ""),
        ("What is the theme of the %(name)s museum?", 
            "slot_entity_about is the topic of the slot_entity_name museum",
            ""),
        ("Can you give me the adress of this museum?", 
            "Sure, the %(name)s museum can be found at slot_entity_adress.",
            "")
    ])
    ...
    histories.append([
        ...
        ("Show me the topic of the first %(number)s museums!", 
            "These are the topics of the first %(number)s museums: slot_df_about",
            "head = %(number)s"),
        ("How popular is the %(index_text)s museum?", 
